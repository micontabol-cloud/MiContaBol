    ...
    <main style={{ maxWidth: 1000, fontFamily: 'sans-serif' }}>
      ...
      {cargando ? (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <BoliMascot pose="pensando" size={90} />
          <p style={{ margin: 0 }}>Aún no tienes productos. ¡Comencemos! Agrega tu primero arriba.</p>
        </div>
            ...
            {productosFiltrados.map((p) => {
              ...
              return (
                <tr key={p.id} style={{ borderBottom: '1px solid #E6ECF3', opacity: p.activo ? 1 : 0.5 }}>
                  ...
                  <td style={{ padding: '4px 8px', textAlign: 'right', color: p.tiene_stock_bajo ? '#EF4444' : undefined, fontWeight: p.tiene_stock_bajo ? 600 : undefined }}>
