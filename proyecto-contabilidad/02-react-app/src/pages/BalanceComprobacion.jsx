  ...
  return (
    <main style={{ maxWidth: 800, margin: '3rem auto', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', flexWrap: 'wrap' }}>
        <div>
          <h1 style={{ margin: 0 }}>Balance de comprobación</h1>
        ...
        <BotonesExportar
          ...
          secciones={[
            {
              columnas: ['Código', 'Cuenta', 'Total debe', 'Total haber', 'Saldo'],
              alineacionDerecha: [2, 3, 4],
              filas: filas.map((f) => [
                f.codigo,
                f.nombre,
                f.total_debe.toFixed(2),
                f.total_haber.toFixed(2),
                f.saldo.toFixed(2),
              ]),
              total: ['', 'TOTALES', totalDebe.toFixed(2), totalHaber.toFixed(2), ''],
            },
          ]}
        />
      </div>
