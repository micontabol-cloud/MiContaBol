...
export default function NuevaCompraProducto() {
  ...
  const [lineas, setLineas] = useState([{ producto_id: '', cantidad: '', costo_unitario: '' }])
  ...
  function actualizarLinea(i, campo, valor) {
    ...
    if (campo === 'producto_id') {
      ...
      if (prod) nuevas[i].costo_unitario = prod.costo_fijo
    }
    setLineas(nuevas)
  }

  function agregarLinea() {
    setLineas([...lineas, { producto_id: '', cantidad: '', costo_unitario: '' }])
  }
