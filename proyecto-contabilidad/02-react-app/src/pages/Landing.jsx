    ...
    >
      ...
      <section className="landing-hero">
        <div className="landing-container landing-hero-grid">
          <div>
            <BoliMascot pose="hola" size={64} style={{ marginBottom: '1rem' }} />
      ...
      <section className="landing-cta">
        <div className="landing-container" style={{ textAlign: 'center' }}>
          <BoliMascot pose="celebrando" size={80} style={{ margin: '0 auto 1rem' }} />
          <h2 className="landing-h2" style={{ color: '#FFFFFF' }}>
            Empieza gratis. 30 días. Sin tarjeta. Sin compromiso.
          </h2>
          <Link to="/login">
            <button className="btn-hero" style={{ marginTop: '1.5rem', fontSize: '1rem', padding: '0.85rem 2rem' }}>
              Crear mi cuenta
            </button>
          </Link>
        </div>
      ...
      <footer className="landing-footer">
        <div className="landing-container landing-footer-grid">
          <div>
            <Logo dark iconSize={24} textSize="0.95rem" />
            <p style={{ color: '#93A5C4', fontSize: '0.85rem', margin: '0.5rem 0 0' }}>Mi contabilidad en el bolsillo.</p>
          </div>
          <div>
