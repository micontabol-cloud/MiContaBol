...
const ALIAS = {
  ...
  observaciones: ['observaciones', 'observacion', 'observación', 'nota', 'notas', 'detalle', 'talla', 'comentario'],
}
    ...
    try {
      ...
      const procesadas = crudo.map((f, i) => {
        ...
        return {
          ...
          observaciones: mapa.observaciones ? String(f[mapa.observaciones] ?? '').trim() : '',
        }
      })
