...
export default function Login() {
  ...
  return (
    <main style={{ maxWidth: 360, margin: '4rem auto', fontFamily: 'sans-serif' }}>
      <p style={{ margin: '0 0 0.25rem', fontWeight: 700, color: '#F2555A', fontSize: '1.1rem' }}>MiContaBol</p>
      <p style={{ margin: '0 0 1.5rem', color: '#64748B', fontSize: '0.85rem' }}>Mi contabilidad en el bolsillo.</p>
      <h1>Ingresar</h1>
