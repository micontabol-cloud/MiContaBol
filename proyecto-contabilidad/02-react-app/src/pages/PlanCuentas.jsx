...
import { sugerenciaSubcuenta, ayudaSubcuenta } from '../lib/sugerenciasCuentas'
                  ...
                  {subAbiertaId === c.id && (
                    <tr>
                      <td colSpan={6} style={{ padding: '8px', background: '#F7F9FC' }}>
                        ...
                        >
                          <span style={{ fontSize: '0.85rem', color: '#64748B', width: '100%' }}>
                            Nueva subcuenta de <strong>{c.nombre}</strong>. {ayudaSubcuenta(c.nombre)}
                          </span>
                          <label>
                            Código
                            <br />
                          ...
                          <label>
                            ...
                            <input
                              required
                              placeholder={`ej. ${sugerenciaSubcuenta(c.nombre, c.tipo)}`}
                              value={subNombre}
