...
const principal = [
  ...
  { to: '/cuentas-por-cobrar', label: 'Clientes', icon: '👥' },
]
  ...
  return (
    <div className="app-shell">
      <aside className="app-sidebar">
        <div>
          <Link to="/empresas" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#FFFFFF' }}>
            <span
              style={{
                width: 8,
                height: 8,
            ...
            />
            <span style={{ fontWeight: 700, fontSize: '1.05rem' }}>MiContaBol</span>
          </Link>
          <p style={{ color: '#93A5C4', fontSize: '0.72rem', margin: '0.25rem 0 0', lineHeight: 1.35 }}>
            Mi contabilidad
            <br />
            en el bolsillo.
          </p>
