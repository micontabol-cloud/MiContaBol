...
export default function NuevaVentaProducto() {
  ...
  const preview = useMemo(() => {
    ...
    const cuentaVentas = cuentaPorId.get(empresa?.cuenta_ventas_id)
    ...
    if (!cuentaVentas) faltantes.push('Ventas')
    ...
    const lineasPreview = [
      ...
      {
        icono: '📈',
        frase: `Registras Bs ${total.toFixed(2)} como venta del mes.`,
        cuenta: cuentaVentas,
        debe: 0,
        haber: total,
      },
  ...
  }, [total, costoTotal, esCredito, metodo, empresa, cuentaPorId, cliente])
  ...
  return (
    <main style={{ maxWidth: 780, fontFamily: 'sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        <p style={{ fontWeight: 700, fontSize: '1.15rem', color: '#1F3A5F', margin: 0 }}>
