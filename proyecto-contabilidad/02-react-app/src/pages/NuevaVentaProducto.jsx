...
export default function NuevaVentaProducto() {
  ...
  // Escanear agrega el producto al carrito directamente: si ya estaba,
  // le suma uno más, que es lo que espera quien pasa varios iguales.
  ...
  return (
    <main style={{ maxWidth: 780, fontFamily: 'sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        <div>
          <EscanerCodigo onCodigo={agregarPorCodigo} placeholder="Escanea un producto para agregarlo..." />
          {avisoEscaneo && <p style={{ color: '#F59E0B', fontSize: '0.88rem' }}>{avisoEscaneo}</p>}
        </div>
