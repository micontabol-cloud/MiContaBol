...
export default function Caja() {
  ...
  return (
    <main style={{ maxWidth: 800, fontFamily: 'sans-serif' }}>
      <h1>Caja</h1>
      <p style={{ color: '#64748B', marginTop: '-0.5rem' }}>Saldo combinado de tus cuentas de caja y bancos.</p>

      <div className="stat-card" style={{ display: 'inline-block', margin: '1rem 0 1.5rem' }}>
        <p className="stat-label">Saldo total</p>
        <p className="stat-value">Bs {totalCajaBancos.toFixed(2)}</p>
      </div>
